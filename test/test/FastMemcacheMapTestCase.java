...
import org.koherent.collection.appengine.FastMemcacheMap;
import org.koherent.collection.appengine.MemcacheMap;

public class FastMemcacheMapTestCase extends FastMapTestCase {
	@Override
	public Map<String, String> getStringToStringMap() {
		return new FastMemcacheMap<String, String>(
				FastMemcacheMapTestCase.class.getName()
						+ "#getStringToStringMap");
	}

	@Override
	public Map<Integer, Long> getIntegerToLongMap() {
		return new FastMemcacheMap<Integer, Long>(FastMemcacheMapTestCase.class
				.getName()
				+ "#getIntegerToLongMap");
	}
